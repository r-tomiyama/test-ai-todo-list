...
const TodoModal = ({ todo, isOpen, onClose, onUpdate, onDelete }: TodoModalProps) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-xl p-8 shadow-lg">
        <h2 className="text-2xl font-bold mb-6 text-[#B08BE2]">TODOを編集</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 text-base"
              disabled={isDeleting}
            >
              {isDeleting ? "削除中..." : "削除"}
            </button>
